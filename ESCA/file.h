...
public:
    VarAssigmentFromPointerStatement(const std::string& varName, const std::string& rhsName, const std::string& loc)
        : varName(varName)
        , rhsName(rhsName)
        , loc(loc)
    {}
...
struct Context {
    ...
    Statement* addVarAssigmentFromFoo(const std::string& varName, const std::string& fooName, const std::string& loc) {
        auto s = new VarAssigmentFromFooStatement(varName, fooName, loc);
        addToLast(s);
        return s;
    }

    Statement* addVarAssigmentFromPointer(const std::string& varName, const std::string& rhsName, const std::string& loc) {
