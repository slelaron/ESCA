...
public:
    void SetReturnVarName(const std::set<std::string>& varName) { returnVarName = varName; isAllocReturns = false; }
    void ClearReturnVarName() { returnVarName.clear(); isAllocReturns = false;  }
